...
module.exports = {
  ...
  */
  ...
  |--------------------------------------------------------------------------
  |
  | This connection has been added to integrate the AdonisJs to the mongo,
  | because its connection does not have a standard connection
  | - Sérgio Venâncio -
  | npm i lucid-mongo
  |
  */
  mongodb: {
    ...
    connection: {
      ...
      database: Env.get('DB_DATABASE', 'start-wars'),
      options: {
